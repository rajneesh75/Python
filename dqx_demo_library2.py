...
dq_engine.save_results_in_table(
    ...
    output_config=OutputConfig(f"{default_catalog_name}.{default_schema_name}.dqx_output", mode="overwrite"),
    quarantine_config=OutputConfig(f"{default_catalog_name}.{default_schema_name}.dqx_quarantine", mode="overwrite")
)
...
dq_engine.apply_checks_by_metadata_and_save_in_table(
    ...
    checks=checks,
    output_config=OutputConfig(f"{default_catalog_name}.{default_schema_name}.dqx_e2e_output", mode="overwrite"),
    quarantine_config=OutputConfig(f"{default_catalog_name}.{default_schema_name}.dqx_e2e_quarantine", mode="overwrite")
)
